  ...
  return (
    <section className="p-8 mb-8 pb-16 rounded-xl md:[45%] ">
      ...
      <div className="grid grid-cols-4 gap-4 h-[300px]">
          ...
          <div className="p-4">
            <Image src="/hackaton-images/chair-beige.png" alt="Chair-white" className="w-full h-50 mb-2 rounded-xl  transition-transform duration-300 ease-in-out hover:scale-110" />
            <h3>Library Stool Chair</h3>
            <p>$20</p>
            <button className=" bg-white border rounded-xl p-2 flex hover:rounded-none hover:duration-200 ml-auto mb-10 -mt-10 hover:bg-black hover:text-white">
             <ShoppingCart />
          ...
          <div className="p-4">
            <Image src="/hackaton-images/chair-gray.png" alt="Chair-white" className="w-full h-50 mb-2 rounded-xl  transition-transform duration-300 ease-in-out hover:scale-110" />
            <h3>Library Stool Chair</h3>
            <p>$20</p>
            <button className=" bg-white border rounded-xl p-2 flex hover:rounded-none hover:duration-200 ml-auto mb-10 -mt-10 hover:bg-black hover:text-white">
             <ShoppingCart />
          ...
          <div className="p-4">
            <Image src="/hackaton-images/chair-black.png" alt="Chair-white" className="w-full h-50 mb-2 rounded-xl  transition-transform duration-300 ease-in-out hover:scale-110" />
            <h3>Library Stool Chair</h3>
            <p>$20</p>
            <button className=" bg-white border rounded-xl p-2 flex hover:rounded-none hover:duration-200 ml-auto mb-10 -mt-10 hover:bg-black hover:text-white">
             <ShoppingCart />
